...
public class DFSResult<V> {
    ...
    public DFSResult(Vertex<V> first, Map<Vertex<V>, Vertex<V>> parentMap, List<Vertex<V>> visitOrder, Set<Edge<V>> treeEdges, Set<Edge<V>> nonTreeEdges, Map<Vertex<V>, Integer> componentMap) {
        this.first = first;
