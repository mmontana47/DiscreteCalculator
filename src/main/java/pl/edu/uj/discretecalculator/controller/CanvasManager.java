...
public class CanvasManager {
    ...
    public List<VertexDrawn> getVertices() {
        return vertices;
    }

    public List<EdgeDrawn> getEdges() {
        return edges;
    }
    ...
    public VertexDrawn createVertex(double x, double y, Consumer<VertexDrawn> onClick, BooleanSupplier canDrag) {
        String generatedId = String.valueOf(nextVertexId++);
        VertexDrawn vertex = new VertexDrawn(x, y, generatedId, onClick, canDrag);
        attachVertex(vertex);
        return vertex;
    }
